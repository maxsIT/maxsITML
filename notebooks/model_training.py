...
def prepare_data_for_training(fict_df, target_column):
    """
    ...
    data_full = fict_df.copy(deep=True)
...
def get_faculty_models(fict_df, target_column):
    """
    ...
    """
    X_data, y = prepare_data_for_training(fict_df, target_column)
...
def train_single_production_model(fict_df, model, target_column):
    """
